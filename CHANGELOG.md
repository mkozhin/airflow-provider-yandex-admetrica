...
- Пример DAG `examples/admetrica_to_bq_and_s3_dag.py` — разворот периода по дням через `expand`, загрузка в S3 с hive-партиционированием и в BigQuery по декоратору партиции
