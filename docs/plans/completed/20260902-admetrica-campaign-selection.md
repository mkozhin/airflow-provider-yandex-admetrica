...
- тег `0.3.0` для публикации на PyPI — одна версия на обе работы, раскладку и
  отбор: ни та, ни другая не выпускались, и на PyPI между `0.2.0` и этим тегом
  ничего не было (версия берётся из тега через
  setuptools-scm)
